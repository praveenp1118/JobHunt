  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Feeds & Scanner</h1>
          <p className="text-sm text-gray-500 mt-0.5">Manage job sources and run the weekly scanner</p>
        </div>
